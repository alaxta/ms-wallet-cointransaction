...
@Component
@Slf4j
public class WalletCoinTransactionKafkaProducer {
    private final KafkaTemplate<String, SendMoneyEvent> kafkaTemplate;
    private final String topic;

    public WalletCoinTransactionKafkaProducer(KafkaTemplate<String, SendMoneyEvent> kafkaTemplate, @Value("${spring.kafka.consumer.topic.name}") String topic) {
